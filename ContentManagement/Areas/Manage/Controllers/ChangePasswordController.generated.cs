...
namespace ContentManagement.Areas.Manage.Controllers
{
    public partial class ChangePasswordController
    {
        ...
        [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
        public ChangePasswordController Actions => MVC.Manage.ChangePassword;
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Manage/Views/ChangePassword/Index.cshtml";
        }
    ...
    [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_ChangePasswordController : ContentManagement.Areas.Manage.Controllers.ChangePasswordController
    {
        public R4MVC_ChangePasswordController(): base (Dummy.Instance)
        {
        }
        ...
        [NonAction]
        partial void IndexOverride(R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult callInfo, ContentManagement.Areas.Manage.Controllers.ChangePasswordModel pass);
        [NonAction]
        public override System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.IActionResult> Index(ContentManagement.Areas.Manage.Controllers.ChangePasswordModel pass)
        {
            var callInfo = new R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "pass", pass);
            IndexOverride(callInfo, pass);
