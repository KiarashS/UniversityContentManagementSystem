...
namespace ContentManagement.Controllers
{
    public partial class LanguageController
    {
        ...
        [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
        public LanguageController Actions => MVC.Language;
    ...
    [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_LanguageController : ContentManagement.Controllers.LanguageController
    {
        public R4MVC_LanguageController(): base (Dummy.Instance)
        {
        }

        [NonAction]
        partial void FaOverride(R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult callInfo);
        [NonAction]
        public override Microsoft.AspNetCore.Mvc.IActionResult Fa()
        {
            var callInfo = new R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult(Area, Name, ActionNames.Fa);
            FaOverride(callInfo);
            return callInfo;
        }

        [NonAction]
        partial void EnOverride(R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult callInfo);
        [NonAction]
        public override Microsoft.AspNetCore.Mvc.IActionResult En()
        {
            var callInfo = new R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult(Area, Name, ActionNames.En);
            EnOverride(callInfo);
            return callInfo;
        }
    }
