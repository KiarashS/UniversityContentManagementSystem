...
namespace ContentManagement.Controllers
{
    ...
    [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_HomeController : ContentManagement.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void ExceptionsOverride(R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult callInfo);
        [NonAction]
        public override System.Threading.Tasks.Task Exceptions()
        {
            var callInfo = new R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult(Area, Name, ActionNames.Exceptions);
            ExceptionsOverride(callInfo);
