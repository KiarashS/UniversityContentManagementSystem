...
namespace ContentManagement.Services.Seo
{
    ...
    public class SeoLinkCanonicalTagHelper : SeoTagHelperBase
    {
        ...
        public SeoLinkCanonicalTagHelper(SeoService seoService)
            : base(seoService)
        {
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var linkCanonical = !string.IsNullOrWhiteSpace(Value) ? Value : _seoService.LinkCanonical;

            linkCanonical = urlHelper?.Content(linkCanonical) ?? linkCanonical;

            var linkCanonicalBase = !string.IsNullOrWhiteSpace(Base) ? Base : _seoService.BaseLinkCanonical;
